...
{
    public class FloydWarshallViewModel : Screen
    {
        ...
        private Node _selectedResultNode;

        public Node SelectedResultNode
        {
            get { return _selectedResultNode; }
            set
            {
                _selectedResultNode = value;
                NotifyOfPropertyChange(() => SelectedResultNode);
            }
        }
        ...
        public void CalculateFloyd()
        {
            ...
            CalculationResult = new BindableCollection<Node>();
